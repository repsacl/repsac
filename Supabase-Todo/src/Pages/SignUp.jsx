        ...
        <div className="h-screen flex justify-center items-center">
          <div className="bg-neutral-900 mx-4 p-8 rounded shadow-xl w-full md:w-1/2 lg:w-1/3">
            ...
            <form>
              ...
              <button
                class="mb-3 w-full max-w-xs font-bold shadow-sm rounded-lg py-3 border-1 border-solid border-blue-700 text-gray-200 flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-blue-700">
